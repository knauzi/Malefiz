...
public class Learning4P {
    ...
    public Learning4P(NeuralNetwork nn, double lambda, double alpha) {
        this.nn = nn;
    ...
    public void train(int numIter) {
        ...
        for(int i = 1; i <= numIter; i++) {
            ...
            Game game = initGame();
            double[] currState = Utils4P.createStateVector(game);
            ...
            while (!game.isOver()) {
                ...
                double[]nextState = Utils4P.createStateVector(game);
    ...
    private void playTestGames() {
        ...
        System.out.println("Win rate of TDL-Agent against 3 ExpertAI's: " + (gamesWonByTDLAgent / 200.0));
    }
